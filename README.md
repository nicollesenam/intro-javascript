...
O código fonte desse projeto pode ser visualizado no arquivo [calculadora.js](https://github.com/nicollesenam/intro-javascript/blob/master/assets/js/calculadora.js) desse repositório.
