...
O código fonte desse projeto pode ser visualizado no [arquivo calculadora deste repositório](https://github.com/nicollesenam/intro-javascript/blob/master/assets/js/calculadora.js) .
